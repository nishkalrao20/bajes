...
__approx_dict__ = { ### TIME-DOMAIN
                    ...
                    'TEOBResumS':                           {'path': 'bajes.obs.gw.approx.teobresums.teobresums_wrapper',
                                                             'type': 'fnc',
                                                             'domain': 'time'},
                    'TEOBResumS_a6cfree':                   {'path': 'bajes.obs.gw.approx.teobresums.teobresums_a6cfree_wrapper',
                                                             'type': 'fnc',
                                                             'domain': 'time'},
                    ...
                    'NRPMw_recal':                          {'path': 'bajes.obs.gw.approx.nrpmw.nrpmw_recal_wrapper',
                                                             'type': 'fnc',
                                                             'domain': 'freq'},
                    'NRPMw_pmonly':                         {'path': 'bajes.obs.gw.approx.nrpmw.nrpmw_attach_wrapper',
                                                             'type': 'fnc',
                                                             'domain': 'freq'},
                    'NRPMw_pmonly_recal':                   {'path': 'bajes.obs.gw.approx.nrpmw.nrpmw_attach_recal_wrapper',
                                                             'type': 'fnc',
                                                             'domain': 'freq'},
